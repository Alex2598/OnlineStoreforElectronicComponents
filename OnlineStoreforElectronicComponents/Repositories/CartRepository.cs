...
namespace OnlineStoreforElectronicComponents.Repositories
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<int> AddItem(int componentId, int qty)
        {
            ...
            try
            {
                ...
                var cartItem = _db.CartDetails
                                  .FirstOrDefault(a => a.ShoppingCartId == cart.Id && a.ComponentId == componentId);
                ...
                {
                    var component = _db.Components.Find(componentId);
                    cartItem = new CartDetail
                    {
                        ComponentId = componentId,
                        ShoppingCartId = cart.Id,
                        Quantity = qty,
                        UnitPrice = component.Price  // it is a new line after update
                    };
        ...
        public async Task<int> RemoveItem(int componentId)
        {
            //using var transaction = _db.Database.BeginTransaction();
            string userId = GetUserId();
            try
        ...
        public async Task<bool> DoCheckout(CheckoutModel model)
        {
            ...
            try
            {
                ...
                foreach(var item in cartDetail)
                {
                    ...
                    var stock = await _db.Stocks.FirstOrDefaultAsync(a => a.ComponentId == item.ComponentId);
                    if (stock == null)
                    {
